...
/*LA EVALUACINO DE PROYECTOS*/
/*create table PUNTAJE
(
	id_pt int(2) not null AUTO_INCREMENT,
...
(
	...
	apellido_ed varchar(50) not null,
	correo_ed varchar(50) not null,
	primary key(id_ed)
);*/

/*POR SI SOLO EXISTE UNA EVALUACION*/
/*create table EVALUACION
(
	id_pr int(4) not null,
	id_ed int(3) not null,
	id_pt int(2) not null,
	obser_ec varchar(300) not null,
	nota_ec varchar(300),
	primary key(id_pr),
	foreign key(id_ed) references EVALUADOR(id_ed),
	foreign key(id_pt) references PUNTAJE(id_pt),
	foreign key(id_pr) references PROYECTO(id_pr)
);*/
